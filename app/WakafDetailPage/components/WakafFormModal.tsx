...
export default function WakafFormModal({
  isOpen,
  onClose,
  onSubmit,
  isSubmitting,
  ...
  const [doa, setDoa] = useState(""); // <-- Dipindahkan ke atas

  // Early return harus SETELAH semua hooks dideklarasikan
      ...
      <div className="relative bg-white w-full max-w-sm rounded-3xl shadow-2xl flex flex-col overflow-hidden animate-in zoom-in-95 duration-200">
        ...
        <div className="px-5 py-4 flex items-center justify-between border-b border-gray-100 bg-white">
          ...
          <button
            ...
            className="p-1.5 bg-gray-50 hover:bg-gray-100 rounded-full text-gray-500"
          >
            <X size={18} />
          </button>
        </div>
        ...
        <form
          ...
          className="p-5 flex flex-col gap-6 max-h-[75vh] overflow-y-auto no-scrollbar"
        >
          {/* Nominal Input */}
          <div>
          ...
          <div className="mt-4 mb-6 text-left">
            ...
            <textarea
              ...
              className="w-full px-4 py-3 rounded-xl border-2 border-gray-100 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 outline-none text-sm text-gray-800 transition-all resize-none"
              rows={3}
            />
            <p className="text-[10px] text-gray-400 mt-1.5 italic">
              Doa Anda akan diaminkan oleh para penerima manfaat.
            </p>
          </div>
          ...
          <div className="bg-emerald-50/50 border border-emerald-100 rounded-xl p-4 flex flex-col gap-3">
            ...
            <div className="flex justify-between items-center border-b border-emerald-100/50 pb-2">
              ...
              <span className="text-xs font-bold text-gray-800 text-right truncate max-w-[150px]">
                {displayName}
              </span>
            </div>
            ...
            <div className="flex justify-between items-center border-b border-emerald-100/50 pb-2">
              ...
              <span className="text-xs font-bold text-gray-800 text-right uppercase">
                {displayBank}
              </span>
            </div>
