  ...
  const donationTypes = [
    {
      name: "Wakaf",
      icon: BookOpen,
      desc: "Pahala jariyah yang abadi",
      color: "text-purple-600",
      bg: "bg-purple-50",
      hover: "group-hover:border-purple-300 group-hover:bg-purple-50/50",
    },
    {
      name: "Donasi",
      icon: Gift,
      desc: "Dukungan untuk program ini",
      color: "text-orange-600",
      bg: "bg-orange-50",
      hover: "group-hover:border-orange-300 group-hover:bg-orange-50/50",
    },
  ];
            ...
            return (
              ...
              >
                <div className="flex items-center gap-4">
                  <div
                    className={`w-12 h-12 rounded-full ${type.bg} ${type.color} flex items-center justify-center shrink-0`}
                  >
                    <Icon size={22} />
                  </div>
                  <div className="flex flex-col">
                    <span className="font-bold text-gray-800 group-hover:text-gray-900 text-base">
                      {type.name}
                    </span>
