                    ...
                    <button 
                      ...
                      className={`w-full flex items-center p-4 rounded-2xl transition-all duration-300 border-2 ${
                        isLocked 
                          ...
                          : isSelected 
                            ? "bg-[#7C3996]/10 border-[#7C3996] shadow-md shadow-[#7C3996]/10" 
                            : "bg-white border-transparent shadow-sm hover:border-[#7C3996]/30"
                      }`}
                    >
                      ...
                      <span className={`flex-1 text-left text-[14px] font-bold ${isLocked ? "text-slate-400" : isSelected ? "text-[#7C3996]" : "text-slate-700"}`}>
                        {m.name}
                      </span>
                      
                      {isLocked && <Lock size={18} className="text-slate-400" />}
                      {!isLocked && isSelected && <CheckCircle2 size={22} className="text-[#7C3996] fill-[#7C3996]/20"/>}
                    </button>
                  );
                })}
              </div>
