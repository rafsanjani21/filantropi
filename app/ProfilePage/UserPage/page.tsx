...
export default function UserPage() {
  ...
  // 1. UPDATE STATE FORM SESUAI DATABASE/POSTMAN
  ...
  const fetchProfile = async () => {
    try {
      ...
      // Memuat semua data dari backend
      const loadedForm = {
        name: data.full_name || "",
        nik: data.nik || "",
      ...
      // Load Profile Image dengan perbaikan struktur URL "public/"
      ...
      // Load KTP Image dengan perbaikan struktur URL "public/"
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // 2. SUSUN FORMDATA PERSIS SEPERTI GAMBAR POSTMAN
      ...
      if (!isNew) {
        ...
        formData.append("no_req", form.no_req);
      ...
      if (ktpFile) {
        formData.append("ktp_image_url", ktpFile);
      }
      ...
      if (isNew) {
        ...
        setOriginalKtpPreview(ktpPreview);
